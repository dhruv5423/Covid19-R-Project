...
@fig-cumulativecases displays the progression of COVID-19 cases in Toronto from January 2020 to March 2024.
...
ggplot(cleaned_covid_data, aes(x = reported_date, y = x_id)) +
  ...
  labs(title = "Cumulative COVID-19 Cases Over Time in Toronto",
       x = "Date",
       y = "COVID-19 Cases") +
...
#| fig-cap: "Chance of Hospitalisation by Age Group"
#| fig.width: 5
#| fig.height: 3
#| fig.align: center
#| echo: false
...
ggplot(long_hosp_data, aes(x = Age_Group, y = Rate, fill = Condition)) +
  ...
  labs(title = "Hospitalisation, Intubation, ICU Admission by Age Group",
       x = "Age Group",
       y = "Percentage (%)") +
  theme_minimal() +
